...
.WithTags("Routing")
.WithSummary("Computes a shortest path around walls")
.WithDescription("Grid-based A* pathfinding with 4-direction movement.")
.Produces<PathResponse>(StatusCodes.Status200OK);
